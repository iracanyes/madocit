...
class ContributionGrainFixtures extends Fixture implements DependentFixtureInterface
{
    /**
     * @var \Faker\Generator
     */
    ...
    public const CONTRIBUTION_GRAIN_REFERENCE = 'contributionGrain';
    ...
    public function load(ObjectManager $manager)
    {
        ...
        /* hydratation */
        $contribution->setTitle($this->faker->unique(false,10000)->sentence(2));
        gc_collect_cycles();
        ...
        $contribution->setEditor($this->getReference(EditorFixtures::EDITOR_REFERENCE))
            ->setGroup($this->getReference(GroupFixtures::GROUP_REFERENCE))
                ->setSubject($this->getReference(GrainFixtures::GRAIN_REFERENCE));
        ...
        $this->addReference(self::CONTRIBUTION_GRAIN_REFERENCE, $contribution);
