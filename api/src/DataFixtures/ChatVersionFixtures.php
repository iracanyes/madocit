...
class ChatVersionFixtures extends Fixture implements DependentFixtureInterface
{
    /**
     * @var \Faker\Generator
     */
    ...
    public const CHAT_VERSION_REFERENCE = 'chatVersion';
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $chat->setCreator($this->getReference(EditorFixtures::EDITOR_REFERENCE))
            ->setVersion($this->getReference(VersionFixtures::VERSION_REFERENCE));
        ...
        $this->addReference(self::CHAT_VERSION_REFERENCE, $chat);
