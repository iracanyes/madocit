...
class NoteGrainFixtures extends Fixture implements DependentFixtureInterface
{
    /**
     * @var \Faker\Generator
     */
    ...
    public const NOTE_GRAIN_REFERENCE = 'noteGrain';
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference(self::NOTE_GRAIN_REFERENCE, $note);
