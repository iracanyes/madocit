...
class ChatThemeFixtures extends Fixture implements DependentFixtureInterface
{
    /**
     * @var \Faker\Generator
     */
    ...
    public const CHAT_THEME_REFERENCE = 'chatTheme';
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $chat->setCreator($this->getReference(EditorFixtures::EDITOR_REFERENCE))
            ->setTheme($this->getReference(ThemeFixtures::THEME_REFERENCE));
        ...
        $this->addReference(self::CHAT_THEME_REFERENCE, $chat);
