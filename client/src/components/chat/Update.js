...
import { success } from '../../actions/chat/create';
import { retrieve, update, reset } from '../../actions/chat/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.chat.update.retrieveError,
    retrieveLoading: state.chat.update.retrieveLoading,
    updateError: state.chat.update.updateError,
    updateLoading: state.chat.update.updateLoading,
    deleteError: state.chat.del.error,
    deleteLoading: state.chat.del.loading,
    created: state.chat.create.created,
    deleted: state.chat.del.deleted,
    retrieved: state.chat.update.retrieved,
    updated: state.chat.update.updated,
  };
};
