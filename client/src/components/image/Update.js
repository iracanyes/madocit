...
import { success } from '../../actions/image/create';
import { retrieve, update, reset } from '../../actions/image/update';
import { del, loading, error } from '../../actions/image/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.image.update.retrieveError,
    retrieveLoading: state.image.update.retrieveLoading,
    updateError: state.image.update.updateError,
    updateLoading: state.image.update.updateLoading,
    deleteError: state.image.del.error,
    deleteLoading: state.image.del.loading,
    created: state.image.create.created,
    deleted: state.image.del.deleted,
    retrieved: state.image.update.retrieved,
    updated: state.image.update.updated,
  };
};
