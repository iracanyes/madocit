...
import { success } from '../../actions/editorschats/create';
import { retrieve, update, reset } from '../../actions/editorschats/update';
import { del, loading, error } from '../../actions/editorschats/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.editorschats.update.retrieveError,
    retrieveLoading: state.editorschats.update.retrieveLoading,
    updateError: state.editorschats.update.updateError,
    updateLoading: state.editorschats.update.updateLoading,
    deleteError: state.editorschats.del.error,
    deleteLoading: state.editorschats.del.loading,
    created: state.editorschats.create.created,
    deleted: state.editorschats.del.deleted,
    retrieved: state.editorschats.update.retrieved,
    updated: state.editorschats.update.updated,
  };
};
