...
import { create, loading, error } from '../../actions/editorschats/create';
...
const mapStateToProps = (state) => {
  return {
    ...
    error: state.editorschats.create.error,
    loading: state.editorschats.create.loading,
  };
};
