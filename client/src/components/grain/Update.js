...
import { success } from '../../actions/grain/create';
import { retrieve, update, reset } from '../../actions/grain/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.grain.update.retrieveError,
    retrieveLoading: state.grain.update.retrieveLoading,
    updateError: state.grain.update.updateError,
    updateLoading: state.grain.update.updateLoading,
    deleteError: state.grain.del.error,
    deleteLoading: state.grain.del.loading,
    created: state.grain.create.created,
    deleted: state.grain.del.deleted,
    retrieved: state.grain.update.retrieved,
    updated: state.grain.update.updated,
  };
};
