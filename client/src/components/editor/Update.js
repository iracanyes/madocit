...
import { success } from '../../actions/editor/create';
import { retrieve, update, reset } from '../../actions/editor/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.editor.update.retrieveError,
    retrieveLoading: state.editor.update.retrieveLoading,
    updateError: state.editor.update.updateError,
    updateLoading: state.editor.update.updateLoading,
    deleteError: state.editor.del.error,
    deleteLoading: state.editor.del.loading,
    created: state.editor.create.created,
    deleted: state.editor.del.deleted,
    retrieved: state.editor.update.retrieved,
    updated: state.editor.update.updated,
  };
};
