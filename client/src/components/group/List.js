      ...
      <p><Link to="create" className="btn btn-primary">Create</Link></p>
        ...
        {this.props.data['hydra:member'] && this.props.data['hydra:member'].map(item =>
          <tr key={item['@id']}>
            ...
            <td>{item['owner'] ? itemToLinks(item['owner']) : ''}</td>
            <td>{item['members'] ? itemToLinks(item['members']) : ''}</td>
            <td>{item['privileges'] ? itemToLinks(item['privileges']) : ''}</td>
            <td>{item['contributions'] ? itemToLinks(item['contributions']) : ''}</td>
            <td>
