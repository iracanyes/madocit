...
import { success } from '../../actions/group/create';
import { retrieve, update, reset } from '../../actions/group/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.group.update.retrieveError,
    retrieveLoading: state.group.update.retrieveLoading,
    updateError: state.group.update.updateError,
    updateLoading: state.group.update.updateLoading,
    deleteError: state.group.del.error,
    deleteLoading: state.group.del.loading,
    created: state.group.create.created,
    deleted: state.group.del.deleted,
    retrieved: state.group.update.retrieved,
    updated: state.group.update.updated,
  };
};
