...
import { success } from '../../actions/subject/create';
import { retrieve, update, reset } from '../../actions/subject/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.subject.update.retrieveError,
    retrieveLoading: state.subject.update.retrieveLoading,
    updateError: state.subject.update.updateError,
    updateLoading: state.subject.update.updateLoading,
    deleteError: state.subject.del.error,
    deleteLoading: state.subject.del.loading,
    created: state.subject.create.created,
    deleted: state.subject.del.deleted,
    retrieved: state.subject.update.retrieved,
    updated: state.subject.update.updated,
  };
};
