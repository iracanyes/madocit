...
import { success } from '../../actions/note/create';
import { retrieve, update, reset } from '../../actions/note/update';
import { del, loading, error } from '../../actions/note/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.note.update.retrieveError,
    retrieveLoading: state.note.update.retrieveLoading,
    updateError: state.note.update.updateError,
    updateLoading: state.note.update.updateLoading,
    deleteError: state.note.del.error,
    deleteLoading: state.note.del.loading,
    created: state.note.create.created,
    deleted: state.note.del.deleted,
    retrieved: state.note.update.retrieved,
    updated: state.note.update.updated,
  };
};
