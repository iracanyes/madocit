...
import {retrieve, reset} from '../../actions/note/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/notes/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.note.show.error,
    loading: state.note.show.loading,
    retrieved:state.note.show.retrieved,
