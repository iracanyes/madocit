...
import { success } from '../../actions/theme/create';
import { retrieve, update, reset } from '../../actions/theme/update';
import { del, loading, error } from '../../actions/theme/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.theme.update.retrieveError,
    retrieveLoading: state.theme.update.retrieveLoading,
    updateError: state.theme.update.updateError,
    updateLoading: state.theme.update.updateLoading,
    deleteError: state.theme.del.error,
    deleteLoading: state.theme.del.loading,
    created: state.theme.create.created,
    deleted: state.theme.del.deleted,
    retrieved: state.theme.update.retrieved,
    updated: state.theme.update.updated,
  };
};
