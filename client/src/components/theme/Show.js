...
import {retrieve, reset} from '../../actions/theme/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/themes/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.theme.show.error,
    loading: state.theme.show.loading,
    retrieved:state.theme.show.retrieved,
