...
import { success } from '../../actions/version/create';
import { retrieve, update, reset } from '../../actions/version/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.version.update.retrieveError,
    retrieveLoading: state.version.update.retrieveLoading,
    updateError: state.version.update.updateError,
    updateLoading: state.version.update.updateLoading,
    deleteError: state.version.del.error,
    deleteLoading: state.version.del.loading,
    created: state.version.create.created,
    deleted: state.version.del.deleted,
    retrieved: state.version.update.retrieved,
    updated: state.version.update.updated,
  };
};
