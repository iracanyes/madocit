...
import {retrieve, reset} from '../../actions/version/show';
import { del, loading, error } from '../../actions/version/delete';
  ...
  render() {
    ...
    return <div>
      ...
      {item && <table className="table table-responsive table-striped table-hover">
          ...
          <tbody>
            <tr>
              <th scope="row">assemblyVersion</th>
              <td>{item['assemblyVersion']}</td>
            </tr>
            <tr>
              <th scope="row">executableLibraryName</th>
              <td>{item['executableLibraryName']}</td>
            </tr>
            <tr>
              <th scope="row">programmingModel</th>
              <td>{item['programmingModel']}</td>
            </tr>
            <tr>
              <th scope="row">targetPlatform</th>
              <td>{item['targetPlatform']}</td>
            </tr>
            <tr>
      ...
      {item && <Link to={`/versions/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.version.show.error,
    loading: state.version.show.loading,
    retrieved:state.version.show.retrieved,
    deleteError: state.version.del.error,
    deleteLoading: state.version.del.loading,
    deleted: state.version.del.deleted,
  };
};
