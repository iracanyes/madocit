...
import {retrieve, reset} from '../../actions/privilege/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/privileges/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.privilege.show.error,
    loading: state.privilege.show.loading,
    retrieved:state.privilege.show.retrieved,
