...
import {retrieve, reset} from '../../actions/abuse/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/abuses/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.abuse.show.error,
    loading: state.abuse.show.loading,
    retrieved:state.abuse.show.retrieved,
