...
import { success } from '../../actions/abuse/create';
import { retrieve, update, reset } from '../../actions/abuse/update';
import { del, loading, error } from '../../actions/abuse/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.abuse.update.retrieveError,
    retrieveLoading: state.abuse.update.retrieveLoading,
    updateError: state.abuse.update.updateError,
    updateLoading: state.abuse.update.updateLoading,
    deleteError: state.abuse.del.error,
    deleteLoading: state.abuse.del.loading,
    created: state.abuse.create.created,
    deleted: state.abuse.del.deleted,
    retrieved: state.abuse.update.retrieved,
    updated: state.abuse.update.updated,
  };
};
