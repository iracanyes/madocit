...
import { success } from '../../actions/contribution/create';
import { retrieve, update, reset } from '../../actions/contribution/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.contribution.update.retrieveError,
    retrieveLoading: state.contribution.update.retrieveLoading,
    updateError: state.contribution.update.updateError,
    updateLoading: state.contribution.update.updateLoading,
    deleteError: state.contribution.del.error,
    deleteLoading: state.contribution.del.loading,
    created: state.contribution.create.created,
    deleted: state.contribution.del.deleted,
    retrieved: state.contribution.update.retrieved,
    updated: state.contribution.update.updated,
  };
};
