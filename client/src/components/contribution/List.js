...
import { list, reset } from '../../actions/contribution/list';
import { success } from '../../actions/contribution/delete';
...
const mapStateToProps = (state) => {
  return {
    data: state.contribution.list.data,
    error: state.contribution.list.error,
    loading: state.contribution.list.loading,
    deletedItem: state.contribution.del.deleted,
  };
};
