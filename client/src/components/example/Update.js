...
import { success } from '../../actions/example/create';
import { retrieve, update, reset } from '../../actions/example/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.example.update.retrieveError,
    retrieveLoading: state.example.update.retrieveLoading,
    updateError: state.example.update.updateError,
    updateLoading: state.example.update.updateLoading,
    deleteError: state.example.del.error,
    deleteLoading: state.example.del.loading,
    created: state.example.create.created,
    deleted: state.example.del.deleted,
    retrieved: state.example.update.retrieved,
    updated: state.example.update.updated,
  };
};
