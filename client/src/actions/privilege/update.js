...
export function retrieveError(retrieveError) {
  return {type: 'PRIVILEGE_UPDATE_RETRIEVE_ERROR', retrieveError};
}

export function retrieveLoading(retrieveLoading) {
  return {type: 'PRIVILEGE_UPDATE_RETRIEVE_LOADING', retrieveLoading};
}

export function retrieveSuccess(retrieved) {
  return {type: 'PRIVILEGE_UPDATE_RETRIEVE_SUCCESS', retrieved};
}
...
export function updateError(updateError) {
  return {type: 'PRIVILEGE_UPDATE_UPDATE_ERROR', updateError};
}

export function updateLoading(updateLoading) {
  return {type: 'PRIVILEGE_UPDATE_UPDATE_LOADING', updateLoading};
}

export function updateSuccess(updated) {
  return {type: 'PRIVILEGE_UPDATE_UPDATE_SUCCESS', updated};
}
...
export function reset() {
  return {type: 'PRIVILEGE_UPDATE_RESET'};
}
