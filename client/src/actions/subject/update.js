...
export function retrieveError(retrieveError) {
  return {type: 'SUBJECT_UPDATE_RETRIEVE_ERROR', retrieveError};
}

export function retrieveLoading(retrieveLoading) {
  return {type: 'SUBJECT_UPDATE_RETRIEVE_LOADING', retrieveLoading};
}

export function retrieveSuccess(retrieved) {
  return {type: 'SUBJECT_UPDATE_RETRIEVE_SUCCESS', retrieved};
}
...
export function updateError(updateError) {
  return {type: 'SUBJECT_UPDATE_UPDATE_ERROR', updateError};
}

export function updateLoading(updateLoading) {
  return {type: 'SUBJECT_UPDATE_UPDATE_LOADING', updateLoading};
}

export function updateSuccess(updated) {
  return {type: 'SUBJECT_UPDATE_UPDATE_SUCCESS', updated};
}
...
export function reset() {
  return {type: 'SUBJECT_UPDATE_RESET'};
}
